...
void test_float_line()
{
	...
	float_line(17.4, 99.9, 14.6, 100.9);
	float_line(16.6, 105.4, 14.6, 106.4);
	float_line(17.4, 110.4, 14.6, 111.4);
	float_line(16.1, 114.9, 14.4, 115.6);

	float_line(10.4, 85.4, 8.4, 86.4);

	float_line(9.6, 100.9, 12.4, 99.9);
	float_line(10.4, 106.4, 12.4, 105.4);
	float_line(9.6, 111.4, 12.4, 110.4);
	float_line(9.6, 115.6, 11.9, 114.9);

	float_line(7.4, 100.9, 4.6, 99.9);
	float_line(6.6, 106.4, 4.6, 104.4); // something wrong here
	float_line(7.4, 111.4, 4.6, 110.4);
	float_line(6.1, 115.6, 4.4, 114.9);
	/*
	// reverse
